  ...
  return (
    <View>
      ...
      >
        ...
        Ipsum has been the{" "}
        <Text style={globalStyles.boldFontSize}>industry's</Text> standard dummy
        text ever since the <Text style={globalStyles.boldFontSize}>1500s</Text>
      </Text>
      <Text
        style={[
          globalStyles.blackColor,
      ...
      >
        <Text style={{ color: "rgba(226,23,94,0.53)" }}>•</Text> This book is a
      ...
      >
        <Text style={{ color: "rgba(226,23,94,0.53)" }}>•</Text> The first line
